...
const Hero = () => {
    return (
        <section className='flex bg-background-main w-full padding-x padding-y justify-center items-center max-container'>
            <div className="w-full relative flex flex-col bg-background-sub max-w-screen-xl mx-auto lg:min-h-screen md:min-h-[80vh] sm:min-h-[70vh] max-412:min-h-[100vh] min-h-[80vh] max-se:min-h-[100vh] max-s8:min-h-[93vh] rounded-2xl px-7 sm:pt-14 pt-10 overflow-hidden">
                ...
                <img className="absolute sm:flex hidden bottom-[0%] left-1/2 -translate-x-[30%] w-[590px] max-iPadAir:w-[480px] max-xl:w-[550px] max-sm:w-[500px] h-auto" src={handPhone} alt="Holding Phone" />
                <img
