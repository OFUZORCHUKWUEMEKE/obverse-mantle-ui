...
const ReadyToAccept = () => {
  return (
   <section className='flex bg-background-main w-full padding-x padding-y justify-center items-center max-container'>
            <div className='w-full overflow-hidden relative flex items-center justify-center flex-col bg-background-sub max-w-screen-xl mx-auto lg:min-h-screen md:min-h-[80vh] sm:min-h-[70vh] max-412:min-h-[100vh] min-h-[80vh] max-se:min-h-[100vh] max-s8:min-h-[93vh] rounded-2xl px-7 sm:mb-24 mb-20'>
