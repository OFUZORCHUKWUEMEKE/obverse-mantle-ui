...
const ReadyToAccept = () => {
  return (
   <section className='flex bg-background-main w-full padding-x padding-y justify-center items-center max-container'>
            <div className='w-full overflow-hidden relative flex items-center justify-center flex-col bg-background-sub max-w-screen-xl mx-auto xl:min-h-[80vh] max-xl:min-h-[75vh] max-640:min-h-[70vh] max-s20:min-h-[90vh] max-se:min-h-[85vh] 980:min-h-[70vh] 412:min-h-[75vh] rounded-2xl px-7 sm:mb-24 mb-20'>
